 ...
 */
@WebServlet(name = "servlet_reporte3", urlPatterns = {"/servlet_reporte3"})
public class servlet_reporte3 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            String jrxmlFileName = "WEB-INF/balance.jasper";

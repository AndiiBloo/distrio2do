...
@WebServlet(name = "servlet_reporte1", urlPatterns = {"/servlet_reporte1"})
public class servlet_reporte1 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            String jrxmlFileName = "WEB-INF/reporteCiudad.jasper";

...
public class reporteContabilidadController {
    ...
    public reporteContabilidadController() {
    }
    ...
    public void generarReporteEstado() 
        ...
        JasperReport jasperReport = (JasperReport) JRLoader.loadObjectFromFile(realPath + "/estado.jasper");        
    ...
    public void generarReporteBalance() 
            throws JRException, IOException, SQLException, ClassNotFoundException{
        Connection cn;
        Class.forName("oracle.jdbc.OracleDriver"); 
        String BaseDeDatos = "jdbc:oracle:thin:@localhost:1521:xe";
        ...
        JasperReport jasperReport = (JasperReport) JRLoader.loadObjectFromFile(realPath + "/balance.jasper");        
